...
##       group.names[["ig"]],] %>%
##     dplyr::pull(multiarm.group.indicator) -> arm.names
##
...
##   n.reps = data.multiarm[i.ma, names(data.multiarm)[names(data.multiarm) == no.arms.indicator]]
##
##   if ("numeric" %in% class(n.reps)){
##     as.numeric(n.reps)-1 -> n.reps
##   } else {
##     as.numeric(n.reps[[1]])-1 -> n.reps
##   }
##
...
##
##   # Order dataset
##   if (order(c(group.names[["ig"]], group.names[["cg"]]))[1] == 2){
##     data = data.frame(data)
##     data[order(data[[group.indicator]], decreasing = TRUE),] -> data
##     data[order(data$id),] -> data
##   } else {
##     data = data.frame(data)
##     data[order(data[[group.indicator]]),] -> data
##     data[order(data$id),] -> data
##   }
##
##   # Set class
