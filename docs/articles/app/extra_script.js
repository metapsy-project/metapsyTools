var outerContainer = document.querySelector("body > div.container.template-article > div");
outerContainer.innerHTML = `
<iframe
      src="https://www.metapsy.dev/data-validator"
      frameborder="0"
      seamless="seamless"
      style="
        overflow: hidden;
...
var realContainer = document.querySelector("body > div.container.template-article");
realContainer.style.marginTop = '50px';
realContainer.style.maxWidth = 'unset';

var footerino = document.querySelector("body > div.container.template-article > footer");
footerino.style.display = 'none';
